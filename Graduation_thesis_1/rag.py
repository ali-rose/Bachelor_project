...
# 路径配置
MODEL_PATH = "/root/autodl-tmp/glm4-9B/models/"  # 生成模型路径
...
EMBEDDING_PATH = '/root/autodl-tmp/glm4-9B/embedding_cashe/embeddings.npy'    # 嵌入向量保存路径
METADATA_PATH = '/root/autodl-tmp/glm4-9B/embedding_cashe/metadata.pkl'       # 元数据保存路径
INDEX_PATH = '/root/autodl-tmp/glm4-9B/embedding_cashe/policy_faiss.index'    # FAISS索引保存路径
TOP_K = 5                             # 检索相似文档块的数量
...
model = AutoModelForCausalLM.from_pretrained(
    MODEL_PATH,
    torch_dtype=torch.float32,  # 使用 bfloat16 或 float16
